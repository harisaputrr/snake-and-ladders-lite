...
Begin VB.Form Soal14 
   ...
   Begin VB.Label Label2 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Kabinet yg dipimpin presiden Megawati Dinamakan.."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
