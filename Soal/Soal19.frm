...
Begin VB.Form Soal19 
   ...
   Begin VB.Label Label2 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Nama Perdana Menteri Singapura yg wafat beberapa waktu lalu..."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
